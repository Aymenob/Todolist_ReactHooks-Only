...
function SectionNav({HandleSectionClick,HandleAddingTask,HandleADDClick,inputValue,handlekeydown}) {
  return (
    <div>
    <form style={{display:'grid',gridTemplateColumns:"70% 7%",justifyContent:'center'}} action="javascript:void(0);">
    <input  onKeyDown={handlekeydown} onChange={(e)=>HandleAddingTask(e)} value={inputValue} name="Title" type="text" class="form-control add-task" placeholder="New Task..."></input>
...
<ul style={{display:'grid',gridTemplateColumns:"12% 12% 12%",justifyContent:'center'}} class="nav nav-pills todo-nav">
    <li role="presentation" class="nav-item all-task active"><a onClick={HandleSectionClick} name="All"  href="#" class="nav-link">All</a></li>
